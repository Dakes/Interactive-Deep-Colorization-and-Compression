...
from src.compression.shared.data_utils import generate_test_image
from src.compression.shared.net_architecture import make_enc, make_gen, make_gan, make_multi_scale_disc

# os.environ["CUDA_VISIBLE_DEVICES"]="1"

GIN_FIN = '/home/kiadmin/projects/Interactive-Deep-Colorization-and-Compression/src/compression/compression_grayscale/extreme_compression_gray.gin'
...
for filename in os.listdir(data_test):
    ...
    generate_test_image(encoder, decoder, path_to_file, output_filename, gray=True)

#for img in test_ds.take(num_test_samples):
 #   generate_test_image(encoder, decoder, img, os.path.join(test_out, ), gray=True)
